  ...
  return (
    <>
      <PageTitle 
        ...
        description={`Order confirmation for order #${order.order_number}. Total: GH₵ ${order.total_amount}`}
        image={logoGold}
        url={`https://boutique-frontend-production.up.railway.app/order-confirmation/${order.id}`}
      />
